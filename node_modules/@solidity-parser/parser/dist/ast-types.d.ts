...
export declare type UnaryOp = '-' | '+' | '++' | '~' | 'after' | 'delete' | '!';
...
export declare type PrimaryExpression = BooleanLiteral | NumberLiteral | Identifier | TupleExpression | TypeNameExpression;
